...
namespace MarketHelper.StoreDataSetTableAdapters {
    ...
    public partial class AdminsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Admins] WHERE (([ID] = @Original_ID) AND ([Login] = @Original_" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Admins] ([Login], [Password]) VALUES (@Login, @Password);\r\nSEL" +
                "ECT ID, Login, Password FROM Admins WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Admins] SET [Login] = @Login, [Password] = @Password WHERE (([ID] =" +
                " @Original_ID) AND ([Login] = @Original_Login) AND ([Password] = @Original_Passw" +
                "ord));\r\nSELECT ID, Login, Password FROM Admins WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::MarketHelper.Properties.Settings.Default.StoreConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Login, Password FROM dbo.Admins";
